globals [ min-fertility-age max-fertility-age death-age ]
...
turtles-own [ age energy hair-allele1 hair-allele2 eye-allele1 eye-allele2]
...
to define-genetic       ; viene stabilito il genotipo e di conseguenza il
                             ; fenotipo degli individui iniziali, che non hanno genitori, in accordo con le probabilità
                             ; dell'interfaccia
  let genotype-hair random 100
  set genotype-hair genotype-hair + 1
  if genotype-hair <= starting-blonds-prob [    ; il caso in cui l'individuo sia di omozigote biondo
    set hair-allele1 1
    set hair-allele2 1
  ]
  if genotype-hair > starting-blonds-prob and genotype-hair <= starting-blonds-prob + starting-browns-prob [    ; il caso in cui l'individuo sia di omozigote castano
    set hair-allele1 0
    set hair-allele2 0
  ]
  if genotype-hair > starting-blonds-prob + starting-browns-prob [    ; il caso in cui l'individuo sia di eterozigote (il fenotipo di conseguenza è castano)
...
to define-eye-genetic
  let genotype-eye random 101
  set genotype-eye genotype-eye + 1
  if genotype-eye <= starting-blue-eye-prob [    ; il caso in cui l'individuo sia omozigote con gli occhi azzurri
    set eye-allele1 1
    set eye-allele2 1
  ]
  if genotype-eye > starting-blue-eye-prob and genotype-eye <= starting-blue-eye-prob + starting-brown-eye-prob [    ; il caso in cui l'individuo sia di omozigote occhi neri
    set eye-allele1 0
    set eye-allele2 0
  ]
  if genotype-eye > starting-blue-eye-prob + starting-brown-eye-prob [    ; il caso in cui l'individuo sia di eterozigote (il fenotipo di conseguenza ha gli occhi neri)
    set eye-allele1 random 2
    ifelse eye-allele1 = 0 [ set eye-allele2 1 ][ set eye-allele2 0 ]
  ]
end

to define-fenotype
  ifelse  hair-allele1 = 0 or hair-allele2 = 0 [
    ifelse eye-allele1 = 0 or eye-allele2 = 0 [ set shape "2-castano-neri" ][ set shape "1-castano-azzurri" ]
  ]
  [    ifelse eye-allele1 = 0 or eye-allele2 = 0 [ set shape "3-biondo-neri" ][ set shape "0-biondo-azzurri" ]
  ]
end
...
to go                       ; tutte le tartarughe si muovono casualmente
  ...
  if  starting-blonds-prob + starting-browns-prob > 100
        [user-message "La percentuale di omozigoti biondi più la percentuale di omozigoti castani non puo' superare il 100%"
         stop]
  if  starting-blue-eye-prob + starting-brown-eye-prob > 100
      [user-message "La percentuale di omozigoti biondi più la percentuale di omozigoti castani non puo' superare il 100%"
       stop]
  ask turtles [
    move
...
to reproduce
 ask females[
    if age > min-fertility-age and age < max-fertility-age and energy > 7 [
      let companion one-of males-here with [age > min-fertility-age and age < 55]
      if companion != nobody and [age] of companion < max-fertility-age and [age] of companion > 15[
        let p random 100
        let mother self
        ifelse p <= 50
        [hatch-males 1
...
to generate-son-genotype [mother father]
  ...
  ifelse allele-index = 0     ; si scegli un allele casuale dai capelli della madre
      [set hair-allele1 [hair-allele1] of mother]
      [set hair-allele1 [hair-allele2] of mother]
  set allele-index random 2   ; variabile che memorizza l'indice di un allele
  ifelse allele-index = 0     ; si scegli un allele casuale dai capelli del padre
    [set hair-allele2 [hair-allele1] of father]
    [set hair-allele2 [hair-allele2] of father]
  set allele-index random 2   ; variabile che memorizza l'indice di un allele
  ifelse allele-index = 0     ; si scegli un allele casuale dagli occhi della madre
      [set eye-allele1 [eye-allele1] of mother]
      [set eye-allele1 [eye-allele2] of mother]
  set allele-index random 2   ; variabile che memorizza l'indice di un allele
  ifelse allele-index = 0     ; si scegli un allele casuale dagli occhi del padre
      [set eye-allele2 [eye-allele1] of father]
      [set eye-allele2 [eye-allele2] of father]
  define-fenotype
end
@#$#@#$#@
GRAPHICS-WINDOW
...
"" ""
PENS
"biondi" 1.0 0 -1184463 true "" "plot count turtles with [ hair-allele1 = 1 and hair-allele2 = 1 ]"
"castani" 1.0 0 -6459832 true "" "plot count turtles with [ hair-allele1 = 0 or hair-allele2 = 0 ]"
"occhi neri" 1.0 0 -16777216 true "" "plot count turtles with [ eye-allele1 = 0 or eye-allele2 = 0 ]"
"occhi azzurri" 1.0 0 -13791810 true "" "plot count turtles with [ eye-allele1 = 1 and eye-allele2 = 1 ]"
...
Circle -13791810 true false 56 71 67
Circle -13791810 true false 176 71 67
Circle -16777216 false false 56 71 67
Circle -16777216 false false 176 71 67
Circle -13791810 true false 45 60 90
Circle -13791810 true false 165 60 90

1-castano-azzurri
false
0
Circle -6459832 true false 8 7 285
Circle -16777216 true false 60 75 60
Circle -16777216 true false 180 75 60
Rectangle -16777216 true false 60 195 240 225
Circle -13791810 true false 56 71 67
...
Circle -16777216 false false 56 71 67
Circle -16777216 false false 176 71 67
Circle -16777216 true false 57 72 66
Circle -16777216 true false 177 72 66
Circle -16777216 true false 45 60 90
Circle -16777216 true false 165 60 90
